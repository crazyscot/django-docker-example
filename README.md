This is an example web app created from the Docker Django project template, to support https://tools.bitfolk.com/wiki/Docker_on_BitFolk_worked_Django_example.
